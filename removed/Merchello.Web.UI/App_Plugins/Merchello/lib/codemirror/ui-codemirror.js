(function (directives, undefined) {
	...
	directives.CodeMirror = function (uiCodemirrorConfig) {
		return {
			restrict: 'EA',
			require: '?ngModel',
			priority: 1,
	...
	angular.module("umbraco").constant('uiCodemirrorConfig', {}).directive('uiCodemirror', ['uiCodemirrorConfig', merchello.Directives.CodeMirror]);
