namespace Merchello.Tests.IntegrationTests.Services.Shipping
{
    ...
    public class ShippingServiceTests : MerchelloAllInTestBase
    {
        ...
        public void Can_Detect_A_ShipmentStatusChange()
        {
            ...
            var builder = new ShipmentBuilderChain(MerchelloContext.Current, order, order.Items.Select(x => x.Key), Guid.NewGuid(), Constants.ShipmentStatus.Packaging, "Track", "http://url.com", "carrier");
