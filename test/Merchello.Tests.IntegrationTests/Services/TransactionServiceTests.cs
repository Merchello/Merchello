...
namespace Merchello.Tests.IntegrationTests.Services
{
    ...
    public class TransactionServiceTests : ServiceIntegrationTestBase
    {
        ...
        private IInvoiceStatus _status;

        public void Initialize()
        {
            
            _transactionService = PreTestDataWorker.TransactionService;
            ...
            _status = _statuses.First(x => x.Alias == "unpaid");
            _invoice = PreTestDataWorker.MakeExistingInvoice(_customer, _status, address);
