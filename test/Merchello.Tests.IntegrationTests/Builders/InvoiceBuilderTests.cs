...
namespace Merchello.Tests.IntegrationTests.Builders
{
    ...
    public class InvoiceBuilderTests : BuilderTestBase
    {
        ...
        private SalePreparationBase _salePreparationMock;
        ...
        public void Init()
        {
            ...
            // setup the checkout
            _salePreparationMock = new SalePreparationMock(MerchelloContext, _itemCache, _customer);
            ...
            _salePreparationMock.SaveShipmentRateQuote(shipRateQuote);
        }
        ...
        public void Can_Create_The_Default_Invoice_Builder_With_3_Tasks()
        {
            ...
            //// Act
            var invoiceBuild = new InvoiceBuilderChain(_salePreparationMock);
        ...
        public void Can_Add_An_Address_To_An_Invoice()
        {
            ...
            var invoiceBuilder = new InvoiceBuilderChain(_salePreparationMock);
