...
namespace Merchello.Tests.UnitTests.TypeFields
{
    ...
    public class InvoiceItemTypeFieldTests
    {
        ...
        {
            var type = EnumeratedTypeFieldConverter.InvoiceItem().Product;
        ...
        {
            var type = EnumeratedTypeFieldConverter.InvoiceItem().Charge;
        ...
        {
            var type = EnumeratedTypeFieldConverter.InvoiceItem().Shipping;
        ...
        {
            var type = EnumeratedTypeFieldConverter.InvoiceItem().Tax;
        ...
        {
            var type = EnumeratedTypeFieldConverter.InvoiceItem().Credit;
