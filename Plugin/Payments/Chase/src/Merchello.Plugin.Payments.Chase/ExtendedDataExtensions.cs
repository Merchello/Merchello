...
namespace Merchello.Plugin.Payments.Chase
{
    ...
    public static class ExtendedDataExtensions
    {
        ...
        /// <param name="processorSettings">The <see cref="ChaseProcessorSettings"/> to be serialized and saved</param>
        public static void SaveProcessorSettings(this ExtendedDataCollection extendedData, ChaseProcessorSettings processorSettings)
        {
        ...
        /// </summary>
        /// <param name="extendedData">The <see cref="ExtendedDataCollection"/></param>
        /// <returns>The deserialized <see cref="ChaseProcessorSettings"/></returns>
        public static ChaseProcessorSettings GetProcessorSettings(this ExtendedDataCollection extendedData)
        {
            if (!extendedData.ContainsKey(Constants.ExtendedDataKeys.ProcessorSettings)) return new ChaseProcessorSettings();

            return
                JsonConvert.DeserializeObject<ChaseProcessorSettings>(
