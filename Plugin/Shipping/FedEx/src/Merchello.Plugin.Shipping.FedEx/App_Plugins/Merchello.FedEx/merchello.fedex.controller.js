(function (controllers, undefined) {
     ...
     */
    controllers.FedExGatewayProviderController = function ($scope) {
        ...
        */
        $scope.init = function () {
            ...
            $scope.fedExSettings = JSON.parse(settingsString);
    ...
    angular.module("umbraco").controller("Merchello.Plugin.GatewayProviders.Shipping.Dialogs.FedExGatewayProviderController", ['$scope', merchello.Controllers.FedExGatewayProviderController]);
