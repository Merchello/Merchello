...
{
    public class UPSShippingRateTable : IUPSShippingRateTable
    {
        private readonly List<IShipRateTier> _shipRateTiers;
        private readonly Guid _shipMethodKey;

        public UPSShippingRateTable(Guid shipMethodKey)
            : this(shipMethodKey, new List<IShipRateTier>())
        { }

        internal UPSShippingRateTable(Guid shipMethodKey, IEnumerable<IShipRateTier> rows)
        {
            IsTest = false;
        ...
        /// <summary>
        /// The 'unique' ShipMethodKey of the ship method associated with the <see cref="IUPSShippingRateTable"/>
        /// </summary>
