...
namespace Merchello.Examine.LocalStorage
{
    ...
    internal class LocalTempStorageIndexer
    {
        ...
        private bool ClearLuceneDirFiles(Directory baseLuceneDirectory)
        {
            try
            {
                //unlock it!
        ...
        private Attempt<IndexWriter> TryCreateWriter(Directory baseLuceneDirectory, Analyzer analyzer)
        {
            try
            {
