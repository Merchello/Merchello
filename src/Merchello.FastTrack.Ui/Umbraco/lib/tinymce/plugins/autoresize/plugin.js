...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_bobfw78jjfuviwjd.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_bobfw78jjfuviwjd.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_bobfw78jjfuviwjd.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_bobfw78jjfuviwjd.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_bobfw78jjfuviwjd.getAutoResizeBottomMargin(editor);
    ...
    if ($_bobfw78jjfuviwjd.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_8otgyt8gjfuviwja.resize(editor, oldSize);
    });
  };
  var $_auhiwc8fjfuviwj8 = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_auhiwc8fjfuviwj8.register(editor, oldSize);
      $_8otgyt8gjfuviwja.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
