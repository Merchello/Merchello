namespace Merchello.Bazaar.Install.PackageActions
{
    ...
    public class AddPaymentFormsAppConfigKey : IPackageAction
    {
        ...
        /// The key.
        /// </summary>
        private const string Key = "Bazaar:ResolvePaymentForms";
        ...
        public string Alias()
        {
            return "MerchelloBazaar_AddPaymentFormsAppConfigKey";
        }
        ...
        public bool Execute(string packageName, XmlNode xmlData)
        {
            try
            {
                CreateAppSettingsKey(Key, true.ToString());
        ...
        {
            const string Sample = "<Action runat=\"install\" undo=\"true/false\" alias=\"MerchelloBazaar_AddPaymentFormsAppConfigKey\"></Action>";
