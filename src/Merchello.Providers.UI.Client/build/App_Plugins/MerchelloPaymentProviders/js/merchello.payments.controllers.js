...
angular.module('merchello.payments').controller('Merchello.Payments.Dialogs.BraintreeProviderSettingsController',
...
angular.module('merchello.payments').controller('Merchello.Payments.Dialogs.BraintreeStandardAuthorizeCapturePaymentController',
...
angular.module('merchello.payments').controller('Merchello.Payments.Dialogs.BraintreeRefundPaymentController',
    ['$scope', 'invoiceHelper',
        function($scope, invoiceHelper) {
