        ...
        protected override DialogEditorViewDisplay ResolveCore(IPaymentGatewayMethod source)
        {
            ...
            if (editorAtt != null)
                return new DialogEditorViewDisplay()
                {
                    ...
                    EditorView = editorAtt.AuthorizeCaptureEditorView.StartsWith("~/") ? IOHelper.ResolveUrl(editorAtt.AuthorizeCaptureEditorView) : editorAtt.AuthorizeCaptureEditorView
                };
