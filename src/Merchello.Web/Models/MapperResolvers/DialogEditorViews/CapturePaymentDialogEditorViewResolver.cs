namespace Merchello.Web.Models.MapperResolvers
{
    ...
    /// </summary>
    internal class CapturePaymentDialogEditorViewResolver : ValueResolver<IPaymentGatewayMethod, DialogEditorViewDisplay>
    {
        /// <summary>
        /// The resolve core.
        /// </summary>
        ...
        protected override DialogEditorViewDisplay ResolveCore(IPaymentGatewayMethod source)
        {
            ...
            if (editorAtt != null)
                return new DialogEditorViewDisplay()
                {
                    ...
                    EditorView = editorAtt.CapturePaymentEditorView.StartsWith("~/") ? IOHelper.ResolveUrl(editorAtt.CapturePaymentEditorView) : editorAtt.CapturePaymentEditorView
                };
