namespace Merchello.Providers.Payment.Braintree.Provider
{
    ...
    [PaymentGatewayMethod("Braintree Payment Gateway Method Editors",
        "~/App_Plugins/MerchelloPaymentProviders/views/dialogs/braintree.standard.authorizepayment.html",
        "~/App_Plugins/MerchelloPaymentProviders/views/dialogs/braintree.standard.authorizecapturepayment.html",
        "~/App_Plugins/MerchelloPaymentProviders/views/dialogs/braintree.standard.voidpayment.html",
        "~/App_Plugins/MerchelloPaymentProviders/views/dialogs/braintree.standard.refundpayment.html",
        "~/App_Plugins/MerchelloPaymentProviders/views/dialogs/braintree.standard.capturepayment.html")]
    public class BraintreeStandardTransactionPaymentGatewayMethod : BraintreePaymentGatewayMethodBase, IBraintreeStandardTransactionPaymentGatewayMethod
    {
        ...
        protected override IPaymentResult PerformAuthorizeCapturePayment(IInvoice invoice, decimal amount, ProcessorArgumentCollection args)
        {
            ...
            {
                this.GatewayProviderService.ApplyPaymentToInvoice(payment.Key, invoice.Key, AppliedPaymentType.Debit, "Braintree transaction - authorized and captured", amount);
            }
