namespace Merchello.Providers.Payment.BankTransfer.Provider
{
    ...
    /// <summary>
    /// Represents a BankTransferMethod
    /// </summary>    
    [GatewayMethodUi("BankTransferMethod")]
    [PaymentGatewayMethod("Bank transfer")]
    public class BankTransferGatewayMethod : PaymentGatewayMethodBase, IBankTransferGatewayMethod
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BankTransferGatewayMethod"/> class.
        /// </summary>
        ...
        /// The payment method.
        /// </param>
        public BankTransferGatewayMethod(IGatewayProviderService gatewayProviderService, IPaymentMethod paymentMethod)
        ...
        {
            var payment = GatewayProviderService.CreatePayment(PaymentMethodType.Custom, invoice.Total, PaymentMethod.Key);
        ...
        {
            var payment = GatewayProviderService.CreatePayment(PaymentMethodType.Custom, amount, PaymentMethod.Key);
            payment.CustomerKey = invoice.CustomerKey;
            payment.PaymentMethodName = PaymentMethod.Name;
            payment.ReferenceNumber = PaymentMethod.PaymentCode + "-" + invoice.PrefixedInvoiceNumber();
            ...
            GatewayProviderService.ApplyPaymentToInvoice(payment.Key, invoice.Key, AppliedPaymentType.Debit, "Bank Transfer", amount);
