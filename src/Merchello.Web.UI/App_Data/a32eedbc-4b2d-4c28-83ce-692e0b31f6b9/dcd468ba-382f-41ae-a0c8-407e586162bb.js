angular.module('merchello.salesreports').controller('Merchello.Plugins.SalesReports.SalesOverTimeController',
    ...
    function($scope, $element, angularHelper, notificationsService, assetsService, queryDisplayBuilder, queryResultDisplayBuilder) {
        ...
        function filterWithDates(filterStartDate, filterEndDate) {
            ...
            renderReport(merchelloPluginReportSalesOverTimeService.searchByDateRange(listQuery));
        }
        ...
        function defaultData() {
            renderReport(merchelloPluginReportSalesOverTimeService.getDefaultData());
        }
