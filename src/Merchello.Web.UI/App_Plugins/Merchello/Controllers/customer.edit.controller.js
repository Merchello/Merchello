 ...
 */
function CustomerEditController($scope, $routeParams, $location, notificationsService, angularHelper, serverValidationManager, merchelloProductService) {
...
angular.module("umbraco").controller("Merchello.Editors.Customer.EditController", CustomerEditController);