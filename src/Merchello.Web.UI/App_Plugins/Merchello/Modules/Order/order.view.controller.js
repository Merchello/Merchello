 ...
 */
function OrderViewController($scope, $routeParams, $location, notificationsService, angularHelper, serverValidationManager, merchelloProductService) {
...
angular.module("umbraco").controller("Merchello.Editors.Order.ViewController", OrderViewController);