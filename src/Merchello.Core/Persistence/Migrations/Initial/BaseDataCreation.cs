namespace Merchello.Core.Persistence.Migrations.Initial
{
    ...
    internal class BaseDataCreation
    {
        ...
        private void CreateStoreSettingData()
        {
            ...
            _database.Insert("merchStoreSetting", "Key", new StoreSettingDto() { Key = Constants.StoreSettingKeys.NextShipmentNumberKey, Name = "nextIShipmentNumber", Value = "1", TypeName = "System.Int32", CreateDate = DateTime.Now, UpdateDate = DateTime.Now });
