namespace Merchello.Core.Persistence.Migrations.Initial
{
    ...
    internal class DatabaseSchemaCreation
    {
        ...
        private static readonly Dictionary<int, Type> OrderedTables = new Dictionary<int, Type>
        {
            ...
            { 18, typeof(OrderDto) },                                              
            { 19, typeof(ShipmentDto) },                 
            { 20, typeof(OrderItemDto) },
            { 21, typeof(PaymentMethodDto) }, 
            { 22, typeof(PaymentDto) },                
            { 23, typeof(ProductDto) },
            { 24, typeof(ProductVariantDto) },
            { 25, typeof(ProductOptionDto) },
            { 26, typeof(ProductAttributeDto) },
            { 27, typeof(Product2ProductOptionDto) },
            { 28, typeof(CatalogInventoryDto) },
            { 29, typeof(TaxMethodDto) },
            { 30, typeof(ProductVariant2ProductAttributeDto) },           
            { 31, typeof(AppliedPaymentDto) },
            { 32, typeof(ProductVariantIndexDto) },
