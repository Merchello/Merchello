...
namespace Merchello.Core.Persistence.Migrations.Upgrades.TargetVersionOneOneZero
{
    ...
    internal class UpdateOneOneZeroData
    {
        ...
        private void CreateNotificationTriggerData()
        {
            ...
            // shipment 
            _database.Insert("merchNotificationTrigger", "Key", new NotificationTriggerDto() { Key = Constants.NotificationTriggerKeys.ShipmentService.Created, Name = "Shipment is shipped", Binding = NotificationTriggerService.GetBindingValue(typeof(ShipmentService), typeof(Events.NewEventArgs<>)), UpdateDate = DateTime.Now, CreateDate = DateTime.Now });
            _database.Insert("merchNotificationTrigger", "Key", new NotificationTriggerDto() { Key = Constants.NotificationTriggerKeys.ShipmentService.Deleted, Name = "Shipment is deleted", Binding = NotificationTriggerService.GetBindingValue(typeof(ShipmentService), typeof(DeleteEventArgs<>)), UpdateDate = DateTime.Now, CreateDate = DateTime.Now });
        }
