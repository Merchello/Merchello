...
namespace Merchello.Core.Persistence.Mappers
{
    ...
    public class MerchelloMapper
    {
        ...
        private MerchelloMapper()
        {
            ...
            CacheMapper(typeof(ICustomerItemCache), typeof(CustomerItemCacheMapper));            
            CacheMapper(typeof(ICustomerItemCacheLineItem), typeof(CustomerItemRegisterItemMapper));
