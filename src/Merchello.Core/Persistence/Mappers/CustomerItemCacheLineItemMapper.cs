...
namespace Merchello.Core.Persistence.Mappers
{
    ...
    /// </summary>
    internal  sealed class CustomerItemCacheLineItemMapper : MerchelloBaseMapper
    {
        public CustomerItemCacheLineItemMapper()
        {
            BuildMap();
        }
        ...
        internal override void BuildMap()
        {
            ...
            CacheMap<CustomerItemCacheLineItem, CustomerItemCacheItemDto>(src => src.Exported, dto => dto.Exported);
