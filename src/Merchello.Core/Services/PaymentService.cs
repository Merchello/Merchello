...
namespace Merchello.Core.Services
{
    ...
    public class PaymentService : IPaymentService
    {
        ...
        internal IPayment CreatePayment(ICustomer customer, string gatewayAlias, Guid paymentTypeFieldKey, string paymentMethodName, string referenceNumber, decimal amount)
        {
