...
namespace Merchello.Core.Services
{
    public interface INotificationMethodService : IService
    {
        ...
        /// </summary>
        /// <param name="providerKey">The <see cref="IGatewayProvider"/> key</param>
        ...
        Attempt<INotificationMethod> CreateNotificationMethodWithKey(Guid providerKey, string name, bool raiseEvents = true);
