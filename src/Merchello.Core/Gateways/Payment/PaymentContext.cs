...
namespace Merchello.Core.Gateways.Payment
{
    ...
    internal class PaymentContext : GatewayProviderTypedContextBase<PaymentGatewayProviderBase>, IPaymentContext
    {
        ...
        {
            return GatewayProviderResolver.CreateInstanceByGatewayProviderType<PaymentGatewayProviderBase>(GatewayProviderType.Shipping);
        }
        ...
        {
            return GatewayProviderResolver.CreateInstanceByKey<PaymentGatewayProviderBase>(key);
        }
