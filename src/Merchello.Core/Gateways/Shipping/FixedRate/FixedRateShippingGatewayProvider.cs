...
namespace Merchello.Core.Gateways.Shipping.FixedRate
{
    ...
    public class FixedRateShippingGatewayProvider : ShippingGatewayProviderBase, IFixedRateShippingGatewayProvider
    {
        ...
        public FixedRateShippingGatewayProvider(IGatewayProviderService gatewayProviderService, IGatewayProviderSetting gatewayProviderSetting, IRuntimeCacheProvider runtimeCacheProvider)
        ...
        public override IShippingGatewayMethod CreateShippingGatewayMethod(IGatewayResource gatewayResource, IShipCountry shipCountry, string name)
        {
            ...
            var attempt = GatewayProviderService.CreateShipMethodWithKey(GatewayProviderSetting.Key, shipCountry, name, gatewayResource.ServiceCode + string.Format("-{0}", Guid.NewGuid()));
        ...
        {
            var methods = GatewayProviderService.GetShipMethodsByShipCountryKey(GatewayProviderSetting.Key, shipCountry.Key);
            return methods
                .Select(
