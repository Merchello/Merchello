...
namespace Merchello.Core.Gateways.Shipping
{
    ...
    public abstract class ShippingGatewayProviderBase : GatewayProviderBase, IShippingGatewayProvider        
    {
        ...
        protected ShippingGatewayProviderBase(IGatewayProviderService gatewayProviderService, IGatewayProviderSetting gatewayProviderSetting, IRuntimeCacheProvider runtimeCacheProvider)
        ...
        public IEnumerable<IShipMethod> ShipMethods
        {
            get {
                return _shipMethods ??
                       (_shipMethods = GatewayProviderService.GetShipMethodsByShipCountryKey(GatewayProviderSetting.Key));
            }
