...
namespace Merchello.Core.Models
{
    ...
    internal class Basket : IdEntity, IBasket
    {
        ...
        {
            _basketTypeFieldKey = EnumTypeFieldConverter.Basket().GetTypeField(basketType).TypeKey;
        }
        ...
        {
            get { return EnumTypeFieldConverter.Basket().GetTypeField(_basketTypeFieldKey); }
            set
            {
                var reference = EnumTypeFieldConverter.Basket().GetTypeField(value);
