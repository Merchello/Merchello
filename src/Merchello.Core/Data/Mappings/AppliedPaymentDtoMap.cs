namespace Merchello.Core.Data.Mappings
{
    ...
    internal class AppliedPaymentDtoMap : DbEntityConfiguration<AppliedPaymentDto>
    {
        public override void Configure(EntityTypeBuilder<AppliedPaymentDto> entity)
        {
                entity.HasKey(e => e.Pk)
                    .HasName("PK_merchAppliedPayment");
