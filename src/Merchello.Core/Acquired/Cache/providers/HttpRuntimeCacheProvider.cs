namespace Merchello.Core.Cache
{
    ...
    internal class HttpRuntimeCacheProvider : DictionaryCacheProviderBase, IRuntimeCacheProvider
    {
        ...
        protected override IEnumerable<DictionaryEntry> GetDictionaryEntries()
        {
            ...
            return this._cache.Cast<DictionaryEntry>()
        ...
        {
            get { return new ReadLock(this._locker); }
        }

        protected override IDisposable WriteLock
        {
            get { return new WriteLock(this._locker); }
        }
        ...
        {
            return this.GetCacheItem(cacheKey, getCacheItem, null, dependentFiles: null);
        }
        ...
        internal object GetCacheItem(string cacheKey, Func<object> getCacheItem, TimeSpan? timeout, bool isSliding = false, CacheItemPriority priority = CacheItemPriority.Normal, CacheItemRemovedCallback removedCallback = null, CacheDependency dependency = null)
        {
            ...
            {
                result = this._cache.Get(cacheKey) as Lazy<object>; // null if key not found
            }
            ...
            using (var lck = new UpgradeableReadLock(this._locker))
            {
                ...
                if (result == null || GetSafeLazyValue(result, true) == null) // get non-created as NonCreatedValue & exceptions as null
                {
                    ...
                    this._cache.Insert(cacheKey, result, dependency, absolute, sliding, priority, removedCallback);
                }
            }
        ...
        public object GetCacheItem(string cacheKey, Func<object> getCacheItem, TimeSpan? timeout, bool isSliding = false, CacheItemPriority priority = CacheItemPriority.Normal, CacheItemRemovedCallback removedCallback = null, string[] dependentFiles = null)
        {
            ...
            return this.GetCacheItem(cacheKey, getCacheItem, timeout, isSliding, priority, removedCallback, dependency);
        }
        ...
        public void InsertCacheItem(string cacheKey, Func<object> getCacheItem, TimeSpan? timeout = null, bool isSliding = false, CacheItemPriority priority = CacheItemPriority.Normal, CacheItemRemovedCallback removedCallback = null, string[] dependentFiles = null)
        {
            ...
            this.InsertCacheItem(cacheKey, getCacheItem, timeout, isSliding, priority, removedCallback, dependency);
        }
