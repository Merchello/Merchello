namespace Merchello.QuickMart.Controllers
{
    ...
    public class QuickMartBasketController : BasketControllerBase<BasketModel, BasketItemModel, AddItemModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickMartBasketController"/> class.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public QuickMartBasketController()
            : base(
