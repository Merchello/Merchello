namespace Merchello.Implementation.Factories
{
    ...
    {
        /// <summary>
        /// Creates <see cref="TAddItemModel"/> from <see cref="IProductContent"/>.
        /// </summary>
        ...
        {
            var addItem = Create(productContent.AsProductDisplay(), quantity);
            return OnCreate(addItem, productContent);
        }
        ...
        public TAddItemModel Create(ProductDisplay display, int quantity = 1)
        {
            ...
            return OnCreate(addItem, display);
        }
