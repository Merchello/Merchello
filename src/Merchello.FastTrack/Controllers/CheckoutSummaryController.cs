namespace Merchello.FastTrack.Controllers
{
    ...
    public class CheckoutSummaryController : CheckoutSummaryControllerBase<FastTrackCheckoutSummary, FastTrackBillingAddressModel, CheckoutAddressModel, StoreLineItemModel>
    {
        /// <summary>
